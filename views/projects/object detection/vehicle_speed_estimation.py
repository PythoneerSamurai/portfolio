...
detection, object tracking, and perspective transformations, for the purpose of accurately estimating vehicle speeds.
""")
...
that the object travels in order to calculate it's speed, that is if the camera is placed at the front (not a top-down 
...
real life. This is why we have to transform the highway from the perspective of single camera, to a top down view of the
highway, the latter having width and height same as that of the highway in reality. The implementation is quite simple, 
...
above into supervision format, which will be make it easier for filtering detections and annotating the polygon zone
...
vehicles throughout the video. This is important for the correct estimation of vehicle speeds based upon the distance
