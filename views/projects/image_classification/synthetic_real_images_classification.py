...
spreading of a lot of mis-information, primarily in the form of fake images or videos which are produced using 
generative AI.
...
The training subset had a total of 100k images, 50k for each class, whereas the test subset has 20k images, 10k for each 
class.

The dataset was already structured to have a train and test split. In this project I have used the test split for the
purpose of validation. A batch size of 32 was used for training.

Before being fed to the model for training, both the training and validation splits were preprocessed to have a size of 
32 pixels in width and height, rescaled to grayscale, and in case of the PyTorch implementation of this project, 
