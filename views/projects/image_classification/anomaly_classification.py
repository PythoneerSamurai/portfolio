...
Anomaly classification models can also be used for security surveillance, to maintain public 
...
intentional crime (explosion and road accidents), and one class represents the normal flow of things (normal videos).
...
The total image count for the training subset is 1,266,345, and for the test subset is 111,308.
...
rescaled to grayscale, and in the case of the PyTorch implementation of this project, converted to torch tensors.
""")
...
No callbacks were used in this project.
""")
