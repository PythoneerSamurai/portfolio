...
on CT scans of the lungs of COVID infected patients and normal people. **This project has been implemented in both
Keras and PyTorch**.
""")
...
st.write("""
This dataset was not structured to have a training and validation split. In the case of this project, the entire dataset
...
3 2D-Dropout layers, 5 Rectified Linear Unit layers, 3 linear layers, 3 2D-BatchNorm layers, and 1 sigmoid layer as 
the final layer.
""")
